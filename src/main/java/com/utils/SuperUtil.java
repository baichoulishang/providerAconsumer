...
public class SuperUtil {
    ...
    private static String mySql = "select";

    public static void main(String[] args) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        Method method = SuperUtil.class.getMethod("getStringAdd", String.class);
        Object invoke = method.invoke(new SuperUtil(), "a");
        System.out.println(invoke);
        ReentrantLock lock = new ReentrantLock();
        new ReentrantReadWriteLock();
        // ReadOnlyIterator.with(endpoints.iterator());
    ...
    public static String getStringAdd(String... obj) {
        String result = "";
     ...
     * @return
     */
    private static int[] randomNum(int max, int need) {
